...
INSERT INTO rooms (id, name, capacity, description, amenities, color) VALUES
  ('room-1', 'ห้องใหญ่ ชั้น 2', 12, 'ห้องประชุมใหญ่สำหรับการประชุมใหญ่และงานสำคัญ', ARRAY['จอ LED TV', 'ระบบเสียง', 'WiFi', 'เครื่องปรับอากาศ'], 'from-blue-500 to-blue-600'),
  ('room-2', 'ห้องกลาง ชั้น 2', 8, 'ห้องประชุมขนาดกลางเหมาะสำหรับการประชุมทีมงาน', ARRAY['โปรเจคเตอร์', 'WiFi', 'เครื่องปรับอากาศ'], 'from-green-500 to-green-600'),
  ('room-3', 'ห้องเล็ก ชั้น 1', 5, 'ห้องประชุมเล็กสำหรับการประชุมส่วนตัวและงานเร่งด่วน', ARRAY['โปรเจคเตอร์', 'WiFi', 'เครื่องปรับอากาศ'], 'from-orange-500 to-orange-600')
